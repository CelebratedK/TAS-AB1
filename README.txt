Hiya, this is our Git for the data analysis file.

Git is a way to collaborate on code with version control;
if someone messes up code, we can revert back to a previous working version

The first step is to create a github account, then send it on whatsapp
